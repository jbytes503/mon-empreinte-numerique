  ...
  return (
    <div className={styles['carbon-footprint-container']}>
      <div className={styles['main-metric']}>
        <div className={styles['co2-amount']}>{co2Amount} tonnes de CO2</div>
      ...
      <div className={styles['comparison']}>
        En un an, votre empreinte carbone numérique équivaut à {tripComparison} voyages en voiture de Lyon à Nantes ! 
